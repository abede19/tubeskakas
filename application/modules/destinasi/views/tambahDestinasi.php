<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="">
                <a href="<?php echo base_url('Destinasi')?>">Tabel Destinasi Destinasi</a>
            </li>
            <li class="active">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" action="<?php echo base_url('Destinasi/tambahkanDestinasi')?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><label class="col-lg-2">Nama Destinasi</label>
                        ...
                        <div class="form-group"><label class="col-lg-2 ">Jenis Destinasi</label>
                         <div class="col-lg-7"><select class="form-control" name="jenis_destinasi">
